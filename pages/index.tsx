...
export default function Home() {
  ...
  const CalculateAmount = () => {
    ...
    const parsedRate = parseInt(rate.toString(), 10);
    const parsedReamount = parseInt(reamount.toString(), 10);
      ...
      <div className='mx-auto my-auto'>
        <ul>
          <li className='bg-white my-[15px] ml-[20px]'>
            ...
            <div><input className='border-[#123] border-[1px] rounded-sm' type="number" value={amount} onChange={e => setAmount(parseFloat(e.target.value))} min="0" /></div>
          </li>
          <li className='bg-white my-[15px] ml-[20px]'>
            <p>Enter Rate%/कितने दर पर:-</p>
            <div><input className='border-[#123] border-[1px]' type="number" value={rate} onChange={e => setRate(parseFloat(e.target.value))} min="0" /></div>
          </li>
          <li className='bg-white my-[15px] ml-[20px]'>
            <p>Enter Return Amount/प्रतिमाह कितने रुपये लेने हैं:-</p> 
            <div><input className='border-[#123] border-[1px]' type="number" value={reamount} onChange={e => setReamount(parseFloat(e.target.value))} min="0" /></div>
          </li>
